...
@Component({
  ...
  template:`
  <section id="basic_new_invoice_contents" class="info-table-items-wrap margin-top">
  ...
  <div class="info-table">
    <table>
      ...
      <tbody [formGroup]="entryArray">
        <tr *ngFor="let p of entryArray; let i = index;" [formGroupName]="i" class="item-details">
          <td colspan="1">
        ...
        ></kendo-numerictextbox>
          ...
          <td colspan="1">
            <div class="tot-amount">
              ...
              <kendo-textbox style="width:120px;">
          ...
          <td colspan="1">
            <div class="form-group text-right">
            <kendo-textbox style="width:40px;">
