...
export class EditPurchaseOrderComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, public purchaseOrderService: PurchaseOrderService, private route: ActivatedRoute) { }
  ...
  getRouteFromParam() {
    this.route.paramMap.subscribe(params => {
      ...
      if (param) {
        this.purchaseOrderService.getPurchaseOrderDetails(param).subscribe(res => {
  ...
  public editHandler({ sender, rowIndex, dataItem }) {
    ...
    sender.editRow(rowIndex, this.editPurchaseOrderForm.get("purchaseOrderEntryList"));
  }

  public removeHandler({ dataItem, rowIndex }): void {
    (<FormArray>this.editPurchaseOrderForm.get("purchaseOrderEntryList")).removeAt(rowIndex);
  }
